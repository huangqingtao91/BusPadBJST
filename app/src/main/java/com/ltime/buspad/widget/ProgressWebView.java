...
import com.ltime.buspad.App;
import com.ltime.buspad.R;
import com.ltime.buspad.util.FileManager;

/**
 * Created by YF001 on 2018/7/18.
 */
...
public class ProgressWebView extends WebView {
    ...
    private static Uri getOutputMediaFileUri() {
        return Uri.fromFile(FileManager.getImgFile(App.getInstance().getApplicationContext()));
    }
