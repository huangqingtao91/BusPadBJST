...
import com.ltime.buspad.ui.MusicActivityA;
...
public class MusicServicexx extends Service implements MediaPlayer.OnCompletionListener {
    ...
    private void initMusicDatas(Intent intent) {
        ...
        List<MusicData> musicDatas = (List<MusicData>) intent.getSerializableExtra(MusicActivityA.PARAM_MUSIC_LIST);
